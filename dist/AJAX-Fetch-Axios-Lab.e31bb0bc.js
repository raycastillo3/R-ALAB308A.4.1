...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // import { start } from "repl";
...
placeholder.value = "";
placeholder.text = "select a breed";
...
function _initialLoad() {
  _initialLoad = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var response, jsonData, i, name, id, option;
 ...
 * -um Use the other data you have been given to create an informational section within the infoDp element.
    ...
    while (1) switch (_context.prev = _context.next) {
      ...
      case 8:
        ...
        for (i = 0; i < jsonData.length; i++) {
          ...
          url = jsonData[i].url;
          catId = jsonData[i].id;
          alt = 'cat image' + catId; //   const newCarouselItem = document.createElement("div"); //<-- this was before using the Carousel function
          //   newCarouselItem.setAttribute("class", "carousel-item");
          //   const catImg = document.createElement("img");
          //   catImg.setAttribute("class", "d-block w-100");
          //   catImg.src = `${url}`;
          //   catImg.alt = `cat id: ${catId}`;
...
//# sourceMappingURL=/AJAX-Fetch-Axios-Lab.e31bb0bc.js.map